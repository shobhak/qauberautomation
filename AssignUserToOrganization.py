...
class AssignUserToOrgnization(unittest.TestCase):
    ...
    def test_AssignUser(self):
        ...
        time.sleep(2)
        driver.find_element_by_xpath( "//tr[4]/td[1]/em").click()
        time.sleep(2)
        #self.assertEqual('Duke and Sons',driver.find_element_by_xpath("//div[contains(.,'Duke and Sons')]"))
        driver.find_element_by_xpath("//div[contains(.,'Duke and Sons')]").click()
