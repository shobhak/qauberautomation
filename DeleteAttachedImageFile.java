...
public class DeleteAttachedImageFile {

	public static void main(String[] args) {
		/*NOTE NOTE NOTE to upload your own file
		you need to change the code "browser.sendKeys("C:\\Users\\dezlo\\Desktop\\aaaa.png")"
		to any image path you want to upload
		*/
		...
		browser.sendKeys("C:\\Users\\dezlo\\Desktop\\aaaa.png");
		...
		browser1.sendKeys("C:\\Users\\dezlo\\Desktop\\aaaa.png");
		
		File SrcFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		try {
			
			FileUtils.copyFile(SrcFile, new File("D:\\imageBeforeScreenshot1.png"));
		...
		try {
			...
			FileUtils.copyFile(SrcFile1, new File("D:\\imageAfterScreenshot2.png"));
