...
//Verify that Project Owner can see the heading “Pending Withdrawals” on Finances page - Chrome (Workng on Chrome)
...
System.setProperty("webdriver.chrome.driver", "SystemSetPropertyChrome");
		...
		System.out.println("'Pending Withdrawals' is displayed: "+driver.findElement(By.xpath(".//*[@id='content']/div[5]/div[1]")).isDisplayed());
