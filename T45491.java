...
//Verify that Project Owner can see the heading Rejected Withdrawals on Finances page - Chrome
...
System.setProperty("webdriver.chrome.driver", property.getProperty("SystemSetPropertyChrome"));
		...
		System.out.println("'Rejected Withdrawals' is displayed: "+driver.findElement(By.xpath(".//*[@id='content']/div[7]/div[1]")).isDisplayed());
