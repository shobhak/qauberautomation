...
//		Verify that the user can send a message as a QA Engineer - Firefox (Works on Firefox)
...
driver.get(property.getProperty("url"));
		...
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
				...
				driver.findElement(By.xpath(".//*[@id='to_as']")).sendKeys(property.getProperty("T45706SendNewMessageTo"));
				
				//Enter Subject
				driver.findElement(By.id("subject_a")).sendKeys(property.getProperty("T45706SubjectPvtMsg"));
				...
				driver.switchTo().activeElement().sendKeys(property.getProperty("T45706PvtMsgBody"));
