...
#TC: Verify "Entities" link is functional https://bidqa.testrail.net/index.php?/tests/view/76674
...
#Veryfying if "Entities" page opens.
if (driver.find_element(:xpath, "//button[contains(.,'Add Organization')]")).displayed?
  puts "Passed"
else
  puts "Failed"
end
