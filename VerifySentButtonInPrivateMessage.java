...
public class VerifySentButtonInPrivateMessage {
	...
	public static void main(String[] args) {
		...
		//click on sent items
		driver.findElement(By.xpath("//*[@id='content']/div[1]/div/ul/li[4]/a")).click();
		
		//putting the sent items' heading as WebElement string
		WebElement sentbox = driver.findElement(By.xpath("//*[@id='content']/div[3]/div[1]"));
		
		
		//validation
		if(sentbox.isDisplayed())
		{
