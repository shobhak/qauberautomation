...
/**
 * Continue registration with 'Email' and 'Retype Password' fields filled out and all other fields empty.
 */

public class EmailAndRetypePasswordFilledAllOtherBlank {
    ...
    public void EmailAndPasswordFilledAllOtherBlank() {

        //set up faker for data input (email & retype password) randomization
