 ...
 */
public class NameEmailFilledAllOtherBlank {
    ...
    public void  NameAndEmailFilledAllOtherBlank() throws InterruptedException {

        //set up faker for data input (name & email) randomization
