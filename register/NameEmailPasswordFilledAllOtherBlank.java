...
/**
 * Continue registration with 'Name', 'Email' and 'Password' fields filled out and all other fields empty.
 */

public class NameEmailPasswordFilledAllOtherBlank {
    ...
    public void ContinueRegEmailPasswdFilled() {
