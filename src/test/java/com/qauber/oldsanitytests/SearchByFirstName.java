...
public class SearchByFirstName {
    ...
    public String firstName = "Vasia";             // First name in report
    ...
    public void verifyHomepageTitle()
    {
        ...
        WebElement element = driver.findElement(By.xpath("//input[@ng-model='sfnSearchKey']"));
        element.clear();
        ...
        Assert.assertTrue(driver.findElement(By.xpath("//div[@class='media-box-body']/div[1]/div/h4")).getText().contains(firstName));
    }
