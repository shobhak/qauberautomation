...
public class HaveAnAccountIsPresentOn_RegistrationPage {
    ...
    public void StartWebDriver() throws InterruptedException {
        ...
        //Check that "Have an account?" is present on the page
        String Sign = "";
        Sign = driver.findElement(By.xpath("//p[@class='pt-lg text-center']")).getText();
        Assert.assertEquals(Sign, "Have an account?");

        //System.out.println(ActualResult);
        try {
            org.testng.Assert.assertEquals(Sign,  "Have an account?");
