 ...
 * TODO: don't delete first subdepartment (pick a later number)
 * TODO: add preconditions (when available)
 */
public class Delete_SubDepartment_AU extends PageObjectModelResources {
...
//        testConfig().getTestRail().setTester("ElenaB"); //put your name :-)
    ...
    public void deleteDepartmentAU() throws InterruptedException{
        ...
        String expectedResult; //department name
        String actualResult;
