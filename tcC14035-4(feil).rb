...
puts "C14035-4 Title: Verify user can not register with invalid email format."
...
if (driver.find_element(:xpath => "html/body/div[2]/div/div/div[1]/div/div[2]/form/div[2]/span[3]").displayed?)
  puts "Test Passed: error message '#{message.text}' is present"
else
  puts "Test FAIL!!!!!!!!!!!!!!!!"
end
