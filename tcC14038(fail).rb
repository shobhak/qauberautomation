...
puts "C14038 Title: Verify that user can not register with blank 'Company name' field."
...
if (driver.find_element(:xpath => "/html/body/div[2]/div/div/div[1]/div").text.include?('Registration successful'))
  puts "Test FAIL!!!!!!!!!!!!!!!!"
else
  puts "Test Passed"
end
